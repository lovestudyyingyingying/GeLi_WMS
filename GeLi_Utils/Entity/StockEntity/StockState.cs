...
namespace GeLiService_WMS.Entity.StockEntity
{
    public class StockState
    {
        ...
        public static string RunState_Error = "异常";
        public static string RunState_AgvInMaPan = "AGV进入";
        public static string RunState_AgvOutMaPan = "AGV离开";
        public static string RunState_AgvPutDownMaPan = "已放货";
        public static string RunState_AgvGetGoods = "已取货";
        public static string RunState_AgvLeaveMaPan = "已离开";
        public static string RunState_MaPanSet0 = "已置0";
