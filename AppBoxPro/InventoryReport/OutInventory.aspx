<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutInventory.aspx.cs" Inherits="NanXingGuoRen_WMS.InventoryReport.OutInventory" %>
        ...
        <f:Panel runat="server" ShowBorder="false" ShowHeader="false" ID="Panel1" Layout="HBox">
            <Items>
                <f:Grid runat="server" IsDatabasePaging="true" DataKeyNames="ID,prosn" AllowPaging="true" ID="Grid1" OnPageIndexChange="Grid1_PageIndexChange"
                    AllowSorting="true" OnSort="Grid1_Sort" EnableTextSelection="true" SummaryPosition="Bottom" EnableSummary="true" SortField="makedate" Title="出库明细"
                    SortDirection="DESC" EnableRowDoubleClickEvent="true"  OnRowCommand="Grid1_RowCommand"
                    BoxFlex="1" EnableCheckBoxSelect="true">
                    <Toolbars>
                        <f:Toolbar runat="server">
                            <Items>
                                <f:DatePicker runat="server" ID="dp1" Label="出库日期" Width="200px" LabelWidth="80px"></f:DatePicker>
                    ...
                    <Columns>
                      ...
                      <f:BoundField DataField="probar" SortField="probar" Width="150px" HeaderText="出库条码" ColumnID="probar"></f:BoundField>
                        
                        
                        <f:BoundField DataField="makedate" HeaderText="出库时间" Width="120px" DataFormatString="{0:yyyy-MM-dd}"
                            SortField="makedate" ColumnID="makedate"></f:BoundField>
                       <f:BoundField DataField="FaHuodanhao" SortField="FaHuodanhao" Width="150px" HeaderText="出库单号" ColumnID="FaHuodanhao" />
                       
                     <%--   <f:RenderField HeaderText="生产车间" DataField="positionClass" SortField="positionClass" ColumnID="positionClass">
                        </f:RenderField>--%>
                        <f:BoundField DataField="itemno" SortField="itemno" Width="180px" HeaderText="物料编号" ColumnID="itemno"></f:BoundField>

                       <f:BoundField DataField="itemname" SortField="itemname" Width="300px" HeaderText="产品名称" ColumnID="itemname"></f:BoundField>
                        <f:BoundField DataField="lotno" SortField="lotno" Width="200px" HeaderText="批号" ColumnID="lotno"></f:BoundField>

                        <f:BoundField DataField="spec" SortField="spec" Width="90px" HeaderText="规格" ColumnID="spec"></f:BoundField>
                        <f:BoundField DataField="danjianwt" SortField="danjianwt" Width="80px" HeaderText="重量(kg)" ColumnID="danjianwt">
                        </f:BoundField>
                        <%--<f:BoundField DataField="inName" SortField="inName" Width="150px" HeaderText="销售型号" ColumnID="inName"></f:BoundField>--%>

                        <f:RenderField DataField="procount" SortField="procount" Width="100px" HeaderText="出库数量" ColumnID="procount" FieldType="Float" RendererFunction="RenderPrice" SummaryType="Sum" Hidden="true"></f:RenderField>
