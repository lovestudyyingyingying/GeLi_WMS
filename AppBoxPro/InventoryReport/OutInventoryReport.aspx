<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutInventoryReport.aspx.cs" Inherits="NanXingGuoRen_WMS.InventoryReport.OutInventoryReport" %>
                    ...
                    <Toolbars>
                        <f:Toolbar runat="server">
                            <Items>
                                ...
                                <f:TextBox runat="server" Label="发货单号" ID="tbxBatchNo" Width="200px" LabelWidth="80px"></f:TextBox>
                    ...
                    <Columns>
                     ...
                     <%--   <f:RenderField HeaderText="生产车间" DataField="positionClass" SortField="positionClass" ColumnID="positionClass">
                       ...
                       <f:BoundField DataField="itemname" SortField="itemname" Width="300px" HeaderText="产品名称" ColumnID="itemname"></f:BoundField>
                        ...
                        <f:BoundField DataField="danjianwt" SortField="danjianwt" Width="80px" HeaderText="重量(kg)" ColumnID="danjianwt"  Hidden="true">
                        </f:BoundField>
                        <%--<f:BoundField DataField="inName" SortField="inName" Width="150px" HeaderText="销售型号" ColumnID="inName"></f:BoundField>--%>

                        <f:RenderField DataField="inCount" SortField="inCount" Width="100px" HeaderText="出库数量" ColumnID="inCount" FieldType="Float" RendererFunction="RenderPrice" SummaryType="Sum"></f:RenderField>
