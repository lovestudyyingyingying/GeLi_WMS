...
{
    public partial class MoveInventory : PageBase
    {
        //key-列名  value-值
            ...
            string sql = string.Format(
                @"  select  OrderTime,StartLocation,EndLocation,RunState,SendState,MissionNo,
                    a.TrayNo,Mark,StockPlan_ID,proname,batchNo,spec,color,probiaozhun,procount,'箱' unit
                     ...
                     from [NanXingGuoRen_WMS].[dbo].[AGVMissionInfo]where Mark='04' and RunState='已完成' )a 
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            Grid1.PageSize = 1000;
            BindGrid1();
            ExportExcel("调拨明细-"+DateTime.Now.ToString("yyyyMMdd"), Grid1);
        }
