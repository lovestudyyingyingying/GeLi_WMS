...
{
    public partial class OutInventoryReport : PageBase
    {
        //key-列名  value-值
        ...
        private void BindGrid1()
        {
            ...
            string sql = string.Format(@" select FaHuodanhao, count(probar) inCount,makedate,
                itemname,itemno,spec from dbo.probarlist1
                where makedate between '{0}' and '{1}' 
                and len(FaHuodanhao)>0 "
            ...
            sql += " group by FaHuodanhao, itemname,itemno,spec,makedate";
            //Debug.WriteLine(sql);
