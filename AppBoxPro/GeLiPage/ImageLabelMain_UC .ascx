<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ImageLabelMain_UC .ascx.cs"
    Inherits="GeLiPage_WMS.GeLiPage.ImageLabelMain_UC" %>

<f:Panel runat="server" BoxFlex="1" ShowHeader="false" ShowBorder="false"
    Layout="HBox">
    <Items>
        <f:Image runat="server" ImageHeight="60px" MarginTop="10px"
        ...
        <f:Panel runat="server" Layout="VBox" ShowHeader="false" BoxFlex="2"
            ...
            <Items>
                ...
                <f:Label runat="server" MarginTop="-5px" MarginLeft="7px" Text="222" ID="labValue">
                </f:Label>
            </Items>
        </f:Panel>
