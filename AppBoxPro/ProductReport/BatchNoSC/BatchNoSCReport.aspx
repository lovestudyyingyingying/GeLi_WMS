<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BatchNoSCReport.aspx.cs" Inherits="NanXingGuoRen_WMS.ProductReport.BatchNoSCReport" %>
        ...
        <f:Panel runat="server" ShowBorder="false" ShowHeader="false" ID="Panel1" Layout="HBox">
            <Items>
                <f:Grid runat="server" IsDatabasePaging="true" DataKeyNames="ID,prosn" AllowPaging="true" ID="Grid1" OnPageIndexChange="Grid1_PageIndexChange"
                    ...
                    SortField="prodate" Title="批次检验明细"
                    ...
                    <Toolbars>
                        <f:Toolbar runat="server">
                            <Items>
                                ...
                                <f:Button runat="server" ID="btnNew" Text="新增" Icon="DatabaseAdd" OnClick="btnNew_Click"></f:Button>
                    ...
                    <Columns>
                       ...
                       <f:BoundField DataField="proname" SortField="proname" Width="300px" HeaderText="产品名称" ColumnID="proname"></f:BoundField>
                        ...
                        <f:BoundField DataField="prodate" HeaderText="生产时间" Width="160px" DataFormatString="{0:yyyy-MM-dd HH:mm}"
                      ...
                      <%--<f:BoundField DataField="proweight" SortField="proweight" Width="120px" HeaderText="称重重量（kg）" ColumnID="proweight"></f:BoundField>--%>
                     ...
                     <%--   <f:RenderField HeaderText="生产车间" DataField="positionClass" SortField="positionClass" ColumnID="positionClass">
                        ...
                        <f:BoundField DataField="position" SortField="position" Width="80px" HeaderText="机台" ColumnID="position" />
                        <f:BoundField DataField="remark1" SortField="remark1" Width="150px" HeaderText="备注" ColumnID="remark1" ExpandUnusedSpace="true" />
