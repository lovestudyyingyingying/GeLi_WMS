<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TouLiaoReport.aspx.cs" Inherits="NanXingGuoRen_WMS.ProductReport.TouLiaoReport" %>
            ...
            <Items>
                <f:Grid runat="server" IsDatabasePaging="true" DataKeyNames="ID,prosn" AllowPaging="true" ID="Grid1" OnPageIndexChange="Grid1_PageIndexChange"
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="RecTime" HeaderText="投料时间" Width="200px" DataFormatString="{0:yyyy-MM-dd HH:mm}"
                        ...
                        <f:BoundField DataField="userID" SortField="userID" Width="100px" HeaderText="投料人" ColumnID="userID"></f:BoundField>
