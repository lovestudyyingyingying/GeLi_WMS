...
using NanXingGuoRen_WMS.Entity;
...
{
    public partial class SensorStoreyReport : PageBase
    {
        //key-列名  value-值
        ...
        private void BindGrid1()
        {
            ...
            DateTime dtNULL = DateTime.Parse("2000-01-01");
            //IQueryable<SensorStorey> q = null;
            //if (ddlPosition.SelectedValue == "2")
            //{
            //    q = from a in DB2.SensorStorey2
            //        orderby a.RefleshTime descending
            //        select new SensorStorey
            //        {
            //            RefleshTime = a.RefleshTime ?? dtNULL,
            //            position = "2L",
            //            Ammeter1 = a.Ammeter1??0,
            //            Ammeter2 = a.Ammeter2??0,
            //            Ammeter3 = a.Ammeter3??0,
            //            Humidity = a.Humidity??0,
            //            Temperature = a.Temperature??0,
            //            Noise = a.Noise??0,
            //            ToxicGas = a.ToxicGas??0,
            //            Thermostat1 = a.Thermostat1??0,
            //            Thermostat2 = a.Thermostat2??0,
            //            Thermostat3 = a.Thermostat3??0,
            //            Thermostat4 = a.Thermostat4??0,
            //            Thermostat5 = a.Thermostat6??0,
            //            Thermostat6 = a.Thermostat6??0,
            //            DieselOilFlow =0.00,
            ...
            //else
            //{
            //    q = from a in DB2.SensorStorey3
            //        orderby a.RefleshTime descending
            //        select new SensorStorey
            //        {
            //            RefleshTime = a.RefleshTime ?? dtNULL,
            //            position = "3L",
            //            Ammeter1 = a.Ammeter2??0,
            //            Ammeter2 = a.Ammeter2??0,
            //            Ammeter3 = a.Ammeter3??0,
            //            Humidity = a.Humidity??0,
            //            Temperature = a.Temperature??0,
            ...
            //            Thermostat5 = a.Thermostat6??0,
            //            Thermostat6 = a.Thermostat6??0,
            //            DieselOilFlow = a.DieselOilFlow??0,
            //        };
            //}
            var q = from a in DB2.SensorStorey2
                    join b in DB2.SensorStorey3
                    on a.ID equals (b.ID-19053)
                    select new
                    {
                        b.RefleshTime,
                        b.Humidity,
            ...
            if (dp1.SelectedDate.HasValue && dp2.SelectedDate.HasValue)
            {
                ...
                q = q.Where(u => u.RefleshTime >= dtStart && u.RefleshTime <= dtEnd);
            }
