<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BatchNoWeightReport.aspx.cs" Inherits="NanXingGuoRen_WMS.ProductReport.BatchNoWeightReport" %>
        ...
        <f:Panel runat="server" ShowBorder="false" ShowHeader="false" ID="Panel1" Layout="HBox">
            <Items>
                <f:Grid runat="server" IsDatabasePaging="true" DataKeyNames="ID,prosn" AllowPaging="true" ID="Grid1" OnPageIndexChange="Grid1_PageIndexChange"
                    AllowSorting="true" OnSort="Grid1_Sort" EnableTextSelection="true" SummaryPosition="Bottom" EnableSummary="true" SortField="RecTime" Title="批次检验明细"
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="position" SortField="position" Width="150px" HeaderText="机台" ColumnID="position" />
                       
                        <f:BoundField DataField="RecTime" HeaderText="校验时间" Width="180px" DataFormatString="{0:yyyy-MM-dd HH:mm}"
                            SortField="RecTime" ColumnID="RecTime"></f:BoundField>
                     <f:BoundField DataField="trayWeight" SortField="trayWeight" Width="120px" HeaderText="称重重量（kg）" ColumnID="trayWeight"></f:BoundField>
                     ...
                     <%--   <f:RenderField HeaderText="生产车间" DataField="positionClass" SortField="positionClass" ColumnID="positionClass">
                       ...
                       <f:BoundField DataField="proname" SortField="proname" Width="300px" HeaderText="产品名称" ColumnID="proname"></f:BoundField>
                        ...
                        <f:BoundField DataField="prosn" SortField="prosn" Width="180px" HeaderText="条码" ColumnID="prosn">
                        </f:BoundField>
                        ...
                        <f:BoundField DataField="trayCount" SortField="trayCount" Width="120px" HeaderText="数量" ColumnID="trayCount"></f:BoundField>
                      
                        <f:BoundField DataField="biaozhun" SortField="biaozhun" Width="120px" HeaderText="产品标准" ColumnID="biaozhun"></f:BoundField>

                        <f:BoundField DataField="result" SortField="result" Width="150px" HeaderText="检验结果" ColumnID="result"></f:BoundField>
